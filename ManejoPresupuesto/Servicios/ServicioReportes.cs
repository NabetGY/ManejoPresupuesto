...
public interface IServicioReportes
{
    ...
    Task<IEnumerable<ResultadoObtenerPorSemana>> ObtenerReporteSemanal(
        int usuarioId, int mes, int año, dynamic ViewBag);
}
...
public class ServicioReportes: IServicioReportes
{
    ...
    public async Task<ReporteTransaccionesDetalladas> ObtenerReporteTransaccionesDetalladas(
        int usuarioId, int mes, int año, dynamic ViewBag)
    {
        (DateTime fechaInicio, DateTime fechaFin) = GeneracionFechaInicioYFin(mes, año);
        ...
        int usuarioId, int mes, int año, dynamic ViewBag)
    {
        ...
        var modelo = await repositorioTransacciones.ObtenerPorSemana(
            parametro);
    ...
    private (DateTime fechaInicio, DateTime fechaFin) GeneracionFechaInicioYFin(int mes, int año)
    {
